...
**YOU ARE IN: `ism_api/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ism_api/` (rig root) or other directories
...
**Your mail address:** `ism_api/polecats/furiosa`
**Your rig:** ism_api
**Your Witness:** `ism_api/witness`
...
| Ask Witness for help | `gt mail send ism_api/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ism_api/witness`) when:
...
```bash
gt mail send ism_api/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
